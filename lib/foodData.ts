...
export const SYSTEM_FOODS: FoodItem[] = [
  ...
  // ── SUPLEMENTI ───────────────────────────────────────────────────────────────
  { id:'sf-whey',            type:'system', category_id:'cat-supp', name_sr:'Whey protein prah',        search_name:'whey protein prah',                     calories_kcal:400, protein_g:83,  carbs_g:10,  fat_g:5   },
  { id:'sf-protein-puding',  type:'system', category_id:'cat-supp', name_sr:'Proteinski puding',        search_name:'proteinski puding',                     calories_kcal:75,  protein_g:9,   carbs_g:7,   fat_g:1.5 },

  // ── ŽITARICE ─────────────────────────────────────────────────────────────────
  { id:'sf-pirinac-beli',    type:'system', category_id:'cat-zitarice', name_sr:'Beli pirinač (sirovi)',         search_name:'beli pirinac sirov',           calories_kcal:365, protein_g:7,   carbs_g:80,  fat_g:0.7 },
  { id:'sf-testenina-int',   type:'system', category_id:'cat-zitarice', name_sr:'Integralna testenina (sirova)', search_name:'integralna testenina sirova',   calories_kcal:355, protein_g:13,  carbs_g:70,  fat_g:2   },
  { id:'sf-ovsene',          type:'system', category_id:'cat-zitarice', name_sr:'Ovsene pahuljice (sirove)',     search_name:'ovsene pahuljice sirove',       calories_kcal:379, protein_g:13,  carbs_g:68,  fat_g:7   },
  { id:'sf-kus-kus',         type:'system', category_id:'cat-zitarice', name_sr:'Kus-kus (sirovi)',              search_name:'kuskus kus kus sirov',          calories_kcal:355, protein_g:12,  carbs_g:72,  fat_g:2   },
  { id:'sf-kinoja',          type:'system', category_id:'cat-zitarice', name_sr:'Kinoa (sirova)',                search_name:'kinoa kvinoja sirova',          calories_kcal:368, protein_g:14,  carbs_g:64,  fat_g:6   },
  { id:'sf-palenta',         type:'system', category_id:'cat-zitarice', name_sr:'Palenta (suva)',                search_name:'palenta suva kukuruzan griz',   calories_kcal:360, protein_g:8,   carbs_g:77,  fat_g:1   },
  { id:'sf-pirincan-griz',   type:'system', category_id:'cat-zitarice', name_sr:'Pirinčani griz (sirovi)',       search_name:'pirincan griz sirov',           calories_kcal:355, protein_g:7,   carbs_g:80,  fat_g:0.5 },
  { id:'sf-rizo',            type:'system', category_id:'cat-zitarice', name_sr:'Arborio riža / rižoto',         search_name:'arborio riza rizoto sirov',     calories_kcal:352, protein_g:7,   carbs_g:78,  fat_g:0.5 },
  { id:'sf-heljda',          type:'system', category_id:'cat-zitarice', name_sr:'Heljda (sirova)',               search_name:'heljda sirova',                 calories_kcal:343, protein_g:13,  carbs_g:72,  fat_g:3.4 },
  ...
  // ── KROMPIR & MAHUNARKE ──────────────────────────────────────────────────────
  { id:'sf-krompir',         type:'system', category_id:'cat-krompir', name_sr:'Krompir (sirovi)',          search_name:'krompir sirov',                   calories_kcal:77,  protein_g:2,   carbs_g:17,  fat_g:0.1 },
  { id:'sf-batat',           type:'system', category_id:'cat-krompir', name_sr:'Batat / Slatki krompir',   search_name:'batat slatki krompir sirov',      calories_kcal:86,  protein_g:1.6, carbs_g:20,  fat_g:0.1 },
  { id:'sf-kukuruz',         type:'system', category_id:'cat-krompir', name_sr:'Kukuruz (zrno / konzerva)',search_name:'kukuruz zrno konzerva',            calories_kcal:86,  protein_g:3,   carbs_g:19,  fat_g:1.2 },
  { id:'sf-grasak',          type:'system', category_id:'cat-krompir', name_sr:'Grašak (sirovi / zamrz.)', search_name:'grasak sirov zamrznut',            calories_kcal:81,  protein_g:5,   carbs_g:14,  fat_g:0.4 },
  { id:'sf-boranija',        type:'system', category_id:'cat-krompir', name_sr:'Boranija (sirova)',         search_name:'boranija mahune sirova',           calories_kcal:31,  protein_g:2,   carbs_g:7,   fat_g:0.2 },
  { id:'sf-leblebija',       type:'system', category_id:'cat-krompir', name_sr:'Leblebija (sirova)',        search_name:'leblebija slanutak sirova',        calories_kcal:364, protein_g:19,  carbs_g:61,  fat_g:6   },
  { id:'sf-pasulj',          type:'system', category_id:'cat-krompir', name_sr:'Pasulj (sirovi)',           search_name:'pasulj grah sirov',               calories_kcal:337, protein_g:22,  carbs_g:61,  fat_g:1   },
  { id:'sf-socivo',          type:'system', category_id:'cat-krompir', name_sr:'Sočivo (sirovo)',           search_name:'socivo leca sirovo',              calories_kcal:352, protein_g:25,  carbs_g:60,  fat_g:1   },
  ...
  // ── ORAŠASTI PLODOVI ─────────────────────────────────────────────────────────
  { id:'sf-bademi',          type:'system', category_id:'cat-orasasti', name_sr:'Bademi',                search_name:'bademi',                            calories_kcal:579, protein_g:21,  carbs_g:22,  fat_g:50  },
  { id:'sf-orasi',           type:'system', category_id:'cat-orasasti', name_sr:'Orasi',                 search_name:'orasi',                             calories_kcal:654, protein_g:15,  carbs_g:14,  fat_g:65  },
  { id:'sf-lesnici',         type:'system', category_id:'cat-orasasti', name_sr:'Lešnici',               search_name:'lesnici lesnik',                    calories_kcal:628, protein_g:15,  carbs_g:17,  fat_g:61  },
  { id:'sf-kikiriki',        type:'system', category_id:'cat-orasasti', name_sr:'Kikiriki',              search_name:'kikiriki',                          calories_kcal:567, protein_g:26,  carbs_g:16,  fat_g:49  },
  { id:'sf-pistaci',         type:'system', category_id:'cat-orasasti', name_sr:'Pistaći',               search_name:'pistaci',                           calories_kcal:560, protein_g:20,  carbs_g:28,  fat_g:45  },
  { id:'sf-kikiriki-puter',  type:'system', category_id:'cat-orasasti', name_sr:'Kikiriki puter',        search_name:'kikiriki puter',                    calories_kcal:588, protein_g:25,  carbs_g:20,  fat_g:50  },

  // ── SEMENKE ──────────────────────────────────────────────────────────────────
  { id:'sf-chia',            type:'system', category_id:'cat-semenke', name_sr:'Chia semenke',           search_name:'chia semenke',                      calories_kcal:486, protein_g:17,  carbs_g:42,  fat_g:31  },
  { id:'sf-laneno',          type:'system', category_id:'cat-semenke', name_sr:'Laneno seme',            search_name:'laneno seme lanene semenke',        calories_kcal:534, protein_g:18,  carbs_g:29,  fat_g:42  },
  { id:'sf-sem-bundeve',     type:'system', category_id:'cat-semenke', name_sr:'Semenke bundeve',        search_name:'semenke bundeve',                   calories_kcal:559, protein_g:30,  carbs_g:11,  fat_g:49  },
  { id:'sf-sem-suncokret',   type:'system', category_id:'cat-semenke', name_sr:'Semenke suncokreta',     search_name:'semenke suncokreta',                calories_kcal:584, protein_g:21,  carbs_g:20,  fat_g:51  },
  { id:'sf-susam',           type:'system', category_id:'cat-semenke', name_sr:'Susam',                  search_name:'susam',                             calories_kcal:573, protein_g:18,  carbs_g:23,  fat_g:50  },
